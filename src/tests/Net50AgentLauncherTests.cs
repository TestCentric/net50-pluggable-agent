...
{
    public class Net50AgentLauncherTests
    {
        ...
        private const string AGENT_NAME = "net50-pluggable-agent.dll";
        ...
        private Net50AgentLauncher _launcher;
        private TestPackage _package;

        [SetUp]
        public void SetUp()
        {
            _launcher = new Net50AgentLauncher();
